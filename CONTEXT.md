...
Active skills should have names that include the runtime they bind to when ambiguity is likely. The current convention is `<runtime>-<verb>` for collaboration skills (`herdr-pair`), and a short verb or noun otherwise (`ship-it`, `debug-mode`).
